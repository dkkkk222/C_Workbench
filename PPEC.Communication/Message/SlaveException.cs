...
namespace PPEC.Communication.Message
{
    public class SlaveException : Exception
    {
        ...
        private readonly ExceptionResponse _slaveExceptionResponse;
        ...
        internal SlaveException(ExceptionResponse slaveExceptionResponse)
        {
        ...
        internal SlaveException(string message, ExceptionResponse slaveExceptionResponse)
            : base(message)
        {
            _slaveExceptionResponse = slaveExceptionResponse;
        }

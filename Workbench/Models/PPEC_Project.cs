...
{
    public class PPEC_Project : BindableBase
    {
        ...
        private ObservableCollection<PPEC_Project> _children = new ObservableCollection<PPEC_Project>();
        public ObservableCollection<PPEC_Project> Children
        {
